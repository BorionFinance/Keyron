# Keyron v0.3.6 — configuração do Google Drive
...
A versão v0.3.6 já utiliza o mesmo Client ID OAuth da versão estável do Borion. Não é necessário editar `js/config.js`.
