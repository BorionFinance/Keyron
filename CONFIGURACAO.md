# Keyron v0.3.5 — configuração do Google Drive
...
A versão v0.3.5 já utiliza o mesmo Client ID OAuth da versão estável do Borion. Não é necessário editar `js/config.js`.
