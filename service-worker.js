const CACHE_NAME = 'keyron-shell-v1.0.F';
...
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=1.0.F',
  './js/frame-guard.js?v=1.0.F',
  './js/config.js?v=1.0.F',
  './js/crypto.js?v=1.0.F',
  './js/storage.js?v=1.0.F',
  './js/save-engine.js?v=1.0.F',
  './js/vault.js?v=1.0.F',
  './js/generator.js?v=1.0.F',
  './js/breach-check.js?v=1.0.F',
  './js/drive.js?v=1.0.F',
  './js/biometric.js?v=1.0.F',
  './js/offline-access.js?v=1.0.F',
  './js/app.js?v=1.0.F',
  './manifest.json?v=1.0.F',
