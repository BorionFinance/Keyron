const CACHE_NAME = 'keyron-shell-v0.3.6';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.3.6',
  './js/crypto.js?v=0.3.6',
  './js/storage.js?v=0.3.6',
  './js/save-engine.js?v=0.3.6',
  './js/vault.js?v=0.3.6',
  './js/generator.js?v=0.3.6',
  './js/drive.js?v=0.3.6',
  './js/biometric.js?v=0.3.6',
  './js/app.js?v=0.3.6',
  './manifest.json?v=0.3.6',
