const CACHE_NAME = 'keyron-shell-v1.0.F-r10-pdf-mobile';
...
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=1.0.F-r10-pdf-mobile',
  ...
  './js/documents.js?v=1.0.F-docs-r4-pdf-mobile',
  './js/app.js?v=1.0.F-r10-pdf-mobile',
