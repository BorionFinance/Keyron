const CACHE_NAME = 'keyron-shell-v0.3.9';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.3.9',
  './js/crypto.js?v=0.3.9',
  './js/storage.js?v=0.3.9',
  './js/save-engine.js?v=0.3.9',
  './js/vault.js?v=0.3.9',
  './js/generator.js?v=0.3.9',
  './js/drive.js?v=0.3.9',
  './js/biometric.js?v=0.3.9',
  './js/app.js?v=0.3.9',
  './manifest.json?v=0.3.9',
