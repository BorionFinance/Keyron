const CACHE_NAME = 'keyron-shell-v0.4.0';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.4.0',
  './js/crypto.js?v=0.4.0',
  './js/storage.js?v=0.4.0',
  './js/save-engine.js?v=0.4.0',
  './js/vault.js?v=0.4.0',
  './js/generator.js?v=0.4.0',
  './js/breach-check.js?v=0.4.0',
  './js/drive.js?v=0.4.0',
  './js/biometric.js?v=0.4.0',
  './js/app.js?v=0.4.0',
