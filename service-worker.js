const CACHE_NAME = 'keyron-shell-v0.6.2';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.6.2',
  './js/crypto.js?v=0.6.2',
  './js/storage.js?v=0.6.2',
  './js/save-engine.js?v=0.6.2',
  './js/vault.js?v=0.6.2',
  './js/generator.js?v=0.6.2',
  './js/breach-check.js?v=0.6.2',
  './js/drive.js?v=0.6.2',
  './js/biometric.js?v=0.6.2',
  './js/sound.js?v=0.6.2',
  './js/app.js?v=0.6.2',
