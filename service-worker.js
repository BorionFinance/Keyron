const CACHE_NAME = 'keyron-shell-v0.6.3';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.6.3',
  './js/crypto.js?v=0.6.3',
  './js/storage.js?v=0.6.3',
  './js/save-engine.js?v=0.6.3',
  './js/vault.js?v=0.6.3',
  './js/generator.js?v=0.6.3',
  './js/breach-check.js?v=0.6.3',
  './js/drive.js?v=0.6.3',
  './js/biometric.js?v=0.6.3',
  './js/app.js?v=0.6.3',
