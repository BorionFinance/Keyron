const CACHE_NAME = 'keyron-shell-v0.3.8';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.3.8',
  './js/crypto.js?v=0.3.8',
  './js/storage.js?v=0.3.8',
  './js/save-engine.js?v=0.3.8',
  './js/vault.js?v=0.3.8',
  './js/generator.js?v=0.3.8',
  './js/drive.js?v=0.3.8',
  './js/biometric.js?v=0.3.8',
  './js/app.js?v=0.3.8',
  './manifest.json?v=0.3.8',
