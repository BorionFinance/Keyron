const CACHE_NAME = 'keyron-shell-v0.3.5';
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=0.3.5',
  './js/crypto.js?v=0.3.5',
  './js/storage.js?v=0.3.5',
  './js/save-engine.js?v=0.3.5',
  './js/vault.js?v=0.3.5',
  './js/generator.js?v=0.3.5',
  './js/drive.js?v=0.3.5',
  './js/biometric.js?v=0.3.5',
  './js/app.js?v=0.3.5',
  './manifest.json?v=0.3.5',
