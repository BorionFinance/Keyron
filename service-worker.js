const CACHE_NAME = 'keyron-shell-v1.0.F-r2';
...
const SHELL = [
  './',
  './index.html',
  './css/style.css?v=1.0.F-r2',
  './js/frame-guard.js?v=1.0.F-r2',
  './js/config.js?v=1.0.F-r2',
  './js/crypto.js?v=1.0.F-r2',
  './js/storage.js?v=1.0.F-r2',
  './js/save-engine.js?v=1.0.F-r2',
  './js/vault.js?v=1.0.F-r2',
  './js/generator.js?v=1.0.F-r2',
  './js/breach-check.js?v=1.0.F-r2',
  './js/drive.js?v=1.0.F-r2',
  './js/biometric.js?v=1.0.F-r2',
  './js/offline-access.js?v=1.0.F-r2',
  './js/app.js?v=1.0.F-r2',
  './manifest.json?v=1.0.F-r2',
