const CACHE_NAME = 'keyron-shell-v1.0.0';
...
const SHELL = [
  ...
  './js/frame-guard.js?v=1.0.0',
  './js/config.js?v=1.0.0',
  './js/crypto.js?v=1.0.0',
  './js/storage.js?v=1.0.0',
  './js/save-engine.js?v=1.0.0',
  './js/vault.js?v=1.0.0',
  './js/generator.js?v=1.0.0',
  './js/breach-check.js?v=1.0.0',
  './js/drive.js?v=1.0.0',
  './js/biometric.js?v=1.0.0',
  './js/app.js?v=1.0.0',
